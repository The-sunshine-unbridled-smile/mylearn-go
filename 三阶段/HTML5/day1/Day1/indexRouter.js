...
router.get("/product.do",(req,resp)=>{
  //=>controller => DAO => controller resp.send从数据库获取到的数据
  console.log(req.query)
  var data = [
    {id: 1, name: '产品1111', img: 'images/1.jpg', sub: '产品副标题1', price: 30, content: '产品1详情文字内容'},
    {id: 2, name: '产品2222', img: 'images/2.jpg', sub: '产品副标题2', price: 50, content: '产品2详情文字内容'},
    {id: 3, name: '产品3333', img: 'images/3.jpg', sub: '产品副标题3', price: 20, content: '产品3详情文字内容'},
    {id: 4, name: '产品4444', img: 'images/4.jpg', sub: '产品副标题4', price: 60, content: '产品4详情文字内容'},
    {id: 5, name: '产品5555', img: 'images/5.jpg', sub: '产品副标题5', price: 60, content: '产品5详情文字内容'}
  ]
